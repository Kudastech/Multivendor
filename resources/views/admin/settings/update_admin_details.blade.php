                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ url('admin/update-admin-details') }}" method="post"
                            ...
                            <div class="form-group">
                                <label for="text">Admin Username/Email</label>
                                <input type="text" class="form-control" readonly
                                    value="{{ Auth::guard('admin')->user()->email }}">
                            </div>
                            <div class="form-group">
                                <label for="text">Admin Type</label>
                                <input type="email" class="form-control" value="{{ Auth::guard('admin')->user()->type }}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="admin_name">Admin Name</label>
                                <input type="text" class="form-control" name="admin_name" id="admin_name"
                                    placeholder="Enter Admin Name" value="{{ Auth::guard('admin')->user()->name }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="admin_mobile" name="admin_mobile"
                                    placeholder="Enter 11 Digit of Number"
